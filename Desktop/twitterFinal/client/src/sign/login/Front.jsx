...
export const Front = () => {
  ...
  return (
    <>
      <div className="flex mr-70 flex-col md:flex-row md:ml-2 max-w-screen-xl mx-auto p-4">
        {/* Left Logo Column */}
      ...
      {/* Bottom Banner */}
      <div className="bg-blue-500 mr-50 flex flex-col md:flex-row justify-between items-center px-6 py-4 mt-6">
